...
* \subsection s2_1 Диаграмма модулей ПО
* \image html class_full.jpg "Диаграмма модулей ПО"
* На диаграмме модулей представлены структура программного обеспечения состоящая из 7 модулей. \n
...
* \subsection s2_2 Диаграмма артефактов
* Ниже представлены диаграммы артефактов клиентского и серверного приложения. \n
* На данных диаграммах показана зависимость исполняемого файла от динамических библиотек(.dll)
* необходимых для запуска приложения и статических библиотек(.lib) необходимых для сборки приложения.
* Статические библиотеки с префиксом <dfs> являются модулями ПО. Остальные 
* библиотеки являются библиотеками от сторонних разработчиков. \n
* \image html art_cl.jpg "Диаграмма артефактов клиентского приложения"
* \image html art_srv.jpg "Диаграмма артефактов серверного приложения"
